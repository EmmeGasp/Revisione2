...
* Completate le fasi di inserimento/modifica dei certificati. 
* Completata il processo di calcolo delle date
* Resa più completa e dinamica la finestra con i dettagli del certificato selezionato. Il termine 'dinamica' è collegato al fatto che alcuni dati sono presenti/assenti in relazione alle scelte effettuate dall'operatore. Per gli stati, ad esempio airbag, c'è sempre la indicazione dello stato (True/False)
* Diversi controlli sono presenti sia nella fase di inserimento/modifica dei dati. 
