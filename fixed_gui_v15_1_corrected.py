...
class EnhancedCertificateDialogV15_1_Corrected:
    ...
    def _create_complete_form_fields_v15_1_corrected(self):
        ...
        self.fields['capital_barrier_type'] = ttk.Combobox(barrier_row2_frame, width=12, state='readonly',
                                                         values=['protected', 'airbag', 'none', 'dynamic']) # Aggiunto 'dynamic'        
        ...
        # Mappa descrizioni per Tipo Dipendenza
    ...
    def _save_v15_1_corrected(self):
        ...
        for field_name, widget in self.fields.items():
            try:
                if hasattr(widget, 'get'):
                    ...
                    if value:
                        ...
                        if field_name == 'risk_free_rate':
                            ...
                            result_data[field_name] = rf_value / 100.0  # 3.5 -> 0.035
                            print(f"📊 Risk-Free Rate salvato: {rf_value}% -> {result_data[field_name]}")
                        elif field_name == 'coupon_rate':
                            cr_value = float(value)
                            result_data[field_name] = cr_value / 100.0 # Tasso del periodo, es: 2.5% -> 0.025
                        ...
                        elif field_name in ['dynamic_barrier_end_level', 'step_down_rate']:
                ...
                # Handles conversion errors for float() and int()
                ...
                # Handles any other unexpected errors during field processing
...
BARRIERE DINAMICHE:
Abilitata: {cert_data.get('dynamic_barrier_feature', 'N/A')} (Livello Iniziale = Barriera Capitale)
